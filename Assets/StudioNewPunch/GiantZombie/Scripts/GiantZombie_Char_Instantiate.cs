...
public class GiantZombie_Char_Instantiate : MonoBehaviour
{
	...
	void Start()
    {
		...
		pref.gameObject.GetComponent<GiantZombie_CharacterCustomize>().charCustomize(bodyTyp, trousersTyp, tanktopTyp, tshirtTyp, headTyp, trousersVisible, sneakersTyp, legsTyp);
